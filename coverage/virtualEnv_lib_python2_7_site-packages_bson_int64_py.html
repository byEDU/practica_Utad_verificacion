...
<head>
    ...
    <title>Coverage for virtualEnv/lib/python2.7/site-packages/bson/int64.py: 83%</title>
...
<div id="header">
    <div class="content">
        <h1>Coverage for <b>virtualEnv/lib/python2.7/site-packages/bson/int64.py</b> :
...
<p id="t15" class="stm run hide_run"><span class="str">&quot;&quot;&quot;A BSON wrapper for long (int in python3)&quot;&quot;&quot;</span><span class="strut">&nbsp;</span></p>
...
<p id="t19" class="stm run hide_run"><span class="key">if</span> <span class="nam">PY3</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t20" class="stm mis">&nbsp; &nbsp; <span class="nam">long</span> <span class="op">=</span> <span class="nam">int</span><span class="strut">&nbsp;</span></p>
<p id="t21" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t22" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t23" class="stm run hide_run"><span class="key">class</span> <span class="nam">Int64</span><span class="op">(</span><span class="nam">long</span><span class="op">)</span><span class="op">:</span><span class="strut">&nbsp;</span></p>
<p id="t24" class="pln">&nbsp; &nbsp; <span class="str">&quot;&quot;&quot;Representation of the BSON int64 type.</span><span class="strut">&nbsp;</span></p>
<p id="t25" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t26" class="pln"><span class="str">&nbsp; &nbsp; This is necessary because every integral number is an :class:`int` in</span><span class="strut">&nbsp;</span></p>
<p id="t27" class="pln"><span class="str">&nbsp; &nbsp; Python 3. Small integral numbers are encoded to BSON int32 by default,</span><span class="strut">&nbsp;</span></p>
<p id="t28" class="pln"><span class="str">&nbsp; &nbsp; but Int64 numbers will always be encoded to BSON int64.</span><span class="strut">&nbsp;</span></p>
<p id="t29" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t30" class="pln"><span class="str">&nbsp; &nbsp; :Parameters:</span><span class="strut">&nbsp;</span></p>
<p id="t31" class="pln"><span class="str">&nbsp; &nbsp; &nbsp; - `value`: the numeric value to represent</span><span class="strut">&nbsp;</span></p>
<p id="t32" class="pln"><span class="str">&nbsp; &nbsp; &quot;&quot;&quot;</span><span class="strut">&nbsp;</span></p>
<p id="t33" class="pln"><span class="strut">&nbsp;</span></p>
<p id="t34" class="stm run hide_run">&nbsp; &nbsp; <span class="nam">_type_marker</span> <span class="op">=</span> <span class="num">18</span><span class="strut">&nbsp;</span></p>
